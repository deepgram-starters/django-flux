...
Django demo app for Deepgram Flux.
...
```
feat(django-flux): add diarization support
fix(django-flux): resolve WebSocket close handling
refactor(django-flux): simplify session endpoint
